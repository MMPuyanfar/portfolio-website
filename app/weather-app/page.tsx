    ...
    <div className="flex flex-col gap-4 bg-gray-100 min-h-screen">
      ...
      {loadingCity ? (
        ...
        <main className="px-3 max-w-[1280px] mx-auto flex flex-col gap-9 w-full pb-10 pt-4">
          ...
          <Link href={'/'} className="block mx-auto w-96 px-10 py-5 text-xl rounded-3xl bg-[#333] text-white text-center hover:bg-slate-400">Go back to Portfolio website</Link>
        </main>
      )}
    </div>
